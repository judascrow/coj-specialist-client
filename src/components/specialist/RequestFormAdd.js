...
const RequestFormAdd = (props) => {
  ...
  const { register, handleSubmit, errors, control, watch } = useForm({
    ...
    defaultValues: {
      idCard: spData?.idCard ?? "",
      govCard: spData?.govCard ?? "",
      cardExpire:
        moment(spData?.cardExpire).format("YYYY-MM-DD") ?? "2024-12-31",
      prefixName: spData?.prefixName ?? "",
      ...
      domicileNo: spData?.domicileNo ?? undefined,
      domicileMoo: spData?.domicileMoo ?? undefined,
      domicileSoi: spData?.domicileSoi ?? undefined,
      domicileRoad: spData?.domicileRoad ?? undefined,
      domicileProvince: spData?.domicileProvince ?? 0,
      domicileDistrict: spData?.domicileDistrict ?? 0,
      domicileSubDistrict: spData?.domicileSubDistrict ?? 0,
      domicileZipcode: spData?.domicileZipcode ?? undefined,
      domicileTel: spData?.domicileTel ?? undefined,
      domicileFax: spData?.domicileFax ?? undefined,
      domicileEmail: spData?.domicileEmail ?? undefined,
      addressNo: spData?.addressNo ?? undefined,
      addressMoo: spData?.addressMoo ?? undefined,
      addressSoi: spData?.addressSoi ?? undefined,
      addressRoad: spData?.addressRoad ?? undefined,
      addressProvince: spData?.addressProvince ?? 0,
      addressDistrict: spData?.addressDistrict ?? 0,
      addressSubDistrict: spData?.addressSubDistrict ?? 0,
      addressZipcode: spData?.addressZipcode ?? undefined,
      addressTel: spData?.addressTel ?? undefined,
      addressFax: spData?.addressFax ?? undefined,
      addressEmail: spData?.addressEmail ?? undefined,
      contactNo: spData?.contactNo ?? undefined,
      contactMoo: spData?.contactMoo ?? undefined,
      contactSoi: spData?.contactSoi ?? undefined,
      contactRoad: spData?.contactRoad ?? undefined,
      contactProvince: spData?.contactProvince ?? undefined,
      contactDistrict: spData?.contactDistrict ?? undefined,
      contactSubDistrict: spData?.contactSubDistrict ?? undefined,
      contactZipcode: spData?.contactZipcode ?? undefined,
      contactTel: spData?.contactTel ?? undefined,
      contactFax: spData?.contactFax ?? undefined,
      contactEmail: spData?.contactEmail ?? undefined,

      workOccupation: spData?.workOccupation ?? undefined,
      workPosition: spData?.workPosition ?? undefined,
      workPlaces: spData?.workPlaces ?? undefined,
      workRoad: spData?.workRoad ?? undefined,
      workSubDistrict: spData?.workSubDistrict ?? 0,
      workDistrict: spData?.workDistrict ?? 0,
      workProvince: spData?.workProvince ?? 0,
      workZipcode: spData?.workZipcode ?? undefined,
      workTel: spData?.workTel ?? undefined,
      workFax: spData?.workFax ?? undefined,
      workEmail: spData?.workEmail ?? undefined,
      bossFirstName: spData?.bossFirstName ?? undefined,
      bossLastName: spData?.bossLastName ?? undefined,
      bossNo: spData?.bossNo ?? undefined,
      bossMoo: spData?.bossMoo ?? undefined,
      bossSoi: spData?.bossSoi ?? undefined,
      bossRoad: spData?.bossRoad ?? undefined,
      bossSubDistrict: spData?.bossSubDistrict ?? undefined,
      bossDistrict: spData?.bossDistrict ?? undefined,
      bossProvince: spData?.bossProvince ?? undefined,
      bossZipcode: spData?.bossZipcode ?? undefined,
      bossTel: spData?.bossTel ?? undefined,
      bossFax: spData?.bossFax ?? undefined,
      bossEmail: spData?.bossEmail ?? undefined,
      workExperience: spData?.workExperience ?? undefined,

      splTypeID: spData?.splTypeID ?? undefined,
      splSubTypeID: spData?.splSubTypeID ?? undefined,
      regisQualification: spData?.regisQualification ?? undefined,
      regisDocument: spData?.regisDocument ?? undefined,
      regisEver: spData?.regisEver ?? undefined,
      regisEverYear: spData?.regisEverYear ?? undefined,
      regisEverPass: spData?.regisEverPass ?? undefined,
      regisEverPassNo: spData?.regisEverPassNo ?? undefined,
      regisEverNopass: spData?.regisEverNopass ?? undefined,
